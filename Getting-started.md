...
- The API is located at https://api.julica.me/app/sign/api/1.0
...
```bash
curl -X POST \
  http://https://api.julica.me/app/sign/api/1.0/webhook/register \
  -H 'Accept: application/json' \
  -H 'Authorization: Basic YWRtaW46YWRtaW4=' \
  -H 'Content-Type: application/json'
  -d '{
	"file": {
		"url": "file:///path/test.pdf"
	},
	"name": "test",
	"callback": "https://callbackurl/callbackWebhook",
	"users": [
		{
...
```bash
curl --request POST \
  --url http://api.julica.me/app/sign/api/1.0/sign/register \
...
```bash
curl --request GET \
  --url http://api.julica.me/app/sign/api/1.0/file/validate/file_id/1995 \
  --header 'Authorization: Basic YWRtaW46YWRtaW4='
```
...
```bash
curl --request GET \
  --url http://api.julica.me/app/sign/api/1.0/file/list \
  --header 'Authorization: Basic YWRtaW46YWRtaW4=' \
```
...
```bash
curl --request POST \
  --url http://api.julica.me/app/sign/api/1.0/file/88968195-6f0a-4036-ac05-9680feb109e4/elements \
  --header 'Authorization: Basic YWRtaW46YWRtaW4=' \
  --header 'Content-Type: application/json' \
  --data '{
    "coordinates": {
...
```bash
curl --request PATCH \
  --url http://api.julica.me/app/sign/api/1.0/file/87e5d5f0-1a9b-48cd-8146-0ee8b3aafd83/elements/1 \
  --header 'Authorization: Basic YWRtaW46YWRtaW4=' \
  --header 'Content-Type: application/json' \
  --data '{
    "coordinates": {
...
```bash
curl --request POST \
  --url http://api.julica.me/app/sign/api/1.0/account/signature \
  --header 'Authorization: Basic YWRtaW46YWRtaW4=' \
  --header 'Content-Type: application/json' \
  --data '{
...
```bash
curl --request POST \
  --url http://api.julica.me/app/sign/api/1.0/account/signature/elements \
  --header 'Authorization: Basic YWRtaW46YWRtaW4=' \
  --header 'Content-Type: application/json' \
  --data '{
  "elements": [
...
```bash
curl --request PUT \
  --url http://api.julica.me/app/sign/api/1.0/settings/users/$user/settings \
  --header 'Authorization: Basic YWRtaW46YWRtaW4=' \
  --header 'Content-Type: application/json' \
  --data '{
	"phone": "+254100654321"
...
```bash
curl --request POST \
  --url http://api.julica.me/app/sign/api/1.0/sign/file_id/3051/code \
  --header 'Authorization: Basic YWRtaW46YWRtaW4=' \
  --header 'Content-Type: application/json' \
```
#### Sign using code
...
```bash
curl --request POST \
  --url http://api.julica.me/app/sign/api/1.0/sign/file_id/1995 \
  --header 'Authorization: Basic YWRtaW46YWRtaW4=' \
  --header 'Content-Type: application/json' \
  --data '{
  "code": "5150"
